            ...
            {state === "data" && (
                <div>
                    <ul key={courses.index}>
                        ...
                        <li><b>Kennslumisseri: </b> {courses.semester}<ButtonSemester
                            callback={tester}
                            method={'PATCH'}
                            fetchUrl={`${URL}${slug}/courses/${encodedCourseId}`}
                            buttonName={'breyta Kennslumisseri'}
                            nameOfClass={'Inputsmall'}
                            selectName={'Inputsmall'}  // set the ID for the dropdown
                            selectOptions={['Vor', 'Sumar', 'Haust', 'Heilsárs']}  // set the options for the dropdown
                        />
                        </li>
