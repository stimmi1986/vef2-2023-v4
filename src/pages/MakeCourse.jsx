...
export function MakeCourse(deild) {
    ...
    console.log('id: ', courseId, 'deild: ', deild)
    ...
    return (
        ...
        <section>
            ...
            <ButtonOnClick callback={tester} method={'POST'} fetchUrl={`${URL}${slug}/courses/${encodedCourseId}`} buttonName={'viltu eyða Áfanga'} errorName={'Tókst ekki að eyða áfanga'} nameOfClass={'sec'} />
        </section>
        </>
    );
};
