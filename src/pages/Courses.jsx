...
import ButtonMakeCourse from "../components/Button/ButtonMakeCourse";

import "./css/style.css";

const PAGE_SIZE = 10;

export function Courses({ titleName, deild, tester }) {
  ...
  return (
    <>
      ...
      <ButtonMakeCourse callback={tester} method={'POST'} fetchUrl={`${URL}${slug}/courses`} buttonName={'Búa til áfanga'} errorName={'Tókst ekki að búa til áfanga'} />
    </>
  );
}
