...
export function ButtonOnSubmitDescription({ callback, method, fetchUrl, buttonName, errorName, nameOfClass, inputName, inputOfClass }) {
...
export default ButtonOnSubmitDescription;
